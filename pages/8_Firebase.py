...
# 1. Inicializar app con credenciales
credenciales = credentials.Certificate('llave_secreta.json')
# Controlar que no se inicialice dos veces seguidas en Streamlit
...
# 2. Traer documentos
vehiculos_docs = bd_firestore.collection('vehiculos').stream()

# 3. Convertir a diccionarios
datos_lista = [doc.to_dict() for doc in vehiculos_docs]
